...
- [x] Each blog post has a unique OG image
- [x] OG images include post title and author name
- [x] Images follow the site's design system
- [x] og:image meta tag set correctly per post

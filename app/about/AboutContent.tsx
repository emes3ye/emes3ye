    ...
    <div className="max-w-4xl mx-auto px-6 py-16 md:py-24">
      ...
      <AnimatedSection className="mb-16 md:mb-24">
        <a
          ...
          className="inline-flex items-center gap-3 px-6 py-3 rounded-full border border-black/10 bg-background text-foreground font-heading font-semibold text-sm hover:border-accent hover:text-accent transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2"
        >
          <svg
            width="18"
            height="18"
